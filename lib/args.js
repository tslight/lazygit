...
const args  = yargs
	...
	default: true,
      ...
      .option('namespaces', {
	alias: 'n',
	description: 'Namespace to query (group or user)',
	type: 'array',
	default: '',
      })
      .option('projects', {
	alias: 'p',
	description: 'Projects to query (group or user)',
	type: 'array',
      })
      .option('groups', {
	alias: 'g',
	description: 'Groups to query (group or user)',
	type: 'array',
      })
      .option('run', {
	alias: 'r',
	...
	default: 'pull-or-clone',
      ...
      .option('show', {
	alias: 's',
	description: 'API resource to show',
	type: 'string',
      })
      .option('order', {
	alias: 'o',
	description: 'Field to order API resources by',
	type: 'string',
      })
      .option('attribute', {
	alias: 'a',
	description: 'Only show this attribute of object',
	type: 'string',
      })
      .option('filter_key', {
	alias: 'K',
