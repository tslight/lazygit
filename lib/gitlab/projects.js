...
Projects.filterResources = (resources, key, value) => {
...
Projects.sortResources = (resources, key) => {
...
Projects.getAttributes = (resources, attribute) => {
...
Projects.getResource = ({
  ...
  return Projects.getIds()
	...
	.then((resources) => {
	  return Projects.filterResources(resources, filterKey, filterValue);
	})
	.then((resources) => {
	  return Projects.sortResources(resources, sortKey);
	})
	.then((resources) => {
	  return Projects.getAttributes(resources, attribute);
	});
    });
};
