...
lazy.show = () => {
  ...
  case 'projects':
  case 'runners':
    return api.getResources(args.show, args.limit, outputFilters);
  case 'urls':
    return lazy.urls();
  case 'commits':
  ...
  default:
    if (args.groups != undefined) {
      return api.getSubResources('groups', args.show, args.limit, outputFilters);
    } else {
      return api.getSubResources('projects', args.show, args.limit, outputFilters);
    }
    break;
  }
};
